...
#include "rrd.h"
#include "rrdfunc.h"
#cgo linux CFLAGS: -std=c99 -DRRD_LITE -D_DEFAULT_SOURCE -D_BSD_SOURCE -DHAVE_CONFIG_H -D_POSIX_SOURCE -DNUMVERS=1.4009 -D_LINUX_OS
#cgo darwin CFLAGS: -std=c99 -DRRD_LITE -D_DEFAULT_SOURCE -D_BSD_SOURCE -DHAVE_CONFIG_H -D_POSIX_SOURCE -DNUMVERS=1.4009 -D_DARWIN_OS
#cgo LDFLAGS: -lm
*/
import "C"
